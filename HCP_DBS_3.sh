...
#4. Use FSL's FIRT to create bilateral thalamic mask, for use in tracking
...
#load in a .txt file called "HCP-SUBJECTS.txt" listing HCP subject IDs (e.g., 100307, 100408, etc)

SUBJECTS=$(cat /data/HCP-SUBJECTS.txt);
...
for SUBJID in $SUBJECTS; do 
	...
	#use FSL and MRTRix3 functinos to create bilateral thalamus mask for use in tracking
