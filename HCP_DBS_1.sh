...
for SUBJID in $SUBJECTS; do 
	...
	echo dwi2response dhollander -voxels $PP_DIR/RF_VOXELS_DHOLL.mif $PP_DIR/DWI_1MM_BC.mif $PP_DIR/RF_WM_DHOLL.txt $PP_DIR/RF_GM_DHOLL.txt $PP_DIR/RF_CSF_DHOLL.txt >> $SCRIPTNAME
